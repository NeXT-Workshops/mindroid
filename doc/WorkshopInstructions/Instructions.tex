...
\begin{document}
	...
	\end{minipage}
	\begin{center}
	\includegraphics[width=.9\textwidth]{img/MessageServer.png}
	\end{center}	
	...
	\includegraphics[width=.4\textwidth]{img/USB-Client.png}
	\hspace{.05\textwidth}
	\includegraphics[width=.4\textwidth]{img/PANusb1.png}
	
	\includegraphics[width=.4\textwidth]{img/PanAuto.png}
	\hspace{.05\textwidth}
	\includegraphics[width=.4\textwidth]{img/PANusb1.png}
	
	\begin{minipage}{.7\textwidth}
	\item Mit der \textbf{Zurück}-Taste kommst du zurück in das Hauptmenü und die Einstellungen werden übernommen.
	\end{minipage}
	\begin{minipage}{.3\textwidth}
	\includegraphics[width=.8\textwidth]{img/RestartPAN.png}
	\end{minipage}
	...
	\includegraphics[width=.4\textwidth]{img/runDefault.png}
	\includegraphics[width=.4\textwidth]{img/wait.png}
	...
	\ref{tab:sensors} Zeigt die standardmäßige Sensorbelegung, wie sie in der App unter ``Mein Roboter'' definiert sein muss.
	...
	\ref{tab:motors} Zeigt den standardmäßigen Motoranschluss, wie er in der App unter ``Mein Roboter'' definiert sein muss.
	\begin{table}[htbp]
		\begin{center}
		\begin{tabular}{|l|l|}
		\hline
