 ...
 */
public class LT extends AbstractSensorValueComparator {

    public LT(float value, SimpleEV3SensorProperty property) {
        super(value,property);
    }

    public LT(float[] values, ComplexEV3SensorProperty property) {
    ...
    public IConstraint copy() {
        switch(evaluationMode){
            case SIMPLE_VALUE_EVALUATION: return new LT(getValue(), (SimpleEV3SensorProperty) getProperty());
            case COMPLEX_VALUE_EVALUATION: return new LT(getValues(), (ComplexEV3SensorProperty) getProperty());
            default: return null;
        }
    }
}
